...
class Tracking:
    ...
    def run(self, desc_dict: visualizes.ThreeDViewer, image: np.array, fe: ORBFeature, count: Any= get_settings().CAMERA_SCALE) -> models.Frame:
        '''
        Main pipline
        '''
        ...
        desc_dict.frames.append(self.frame)
