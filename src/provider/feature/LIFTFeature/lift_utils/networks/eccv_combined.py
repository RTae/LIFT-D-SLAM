...
from src.provider.feature.LIFTFeature.lift_utils.lasagne_tools import (createConvtScaleSpaceLayer, createResizeLayer,
                                 createXYZCropLayer, createXYZTCropLayer)
from src.provider.feature.LIFTFeature.lift_utils.networks.eccv_base import ECCVNetworkBase, ECCVNetworkConfigBase
...
class Network(ECCVNetworkBase):
    ...
    def buildLayersKp(self, idxSiam, resize, verbose=True):
        ...
        detector_module = importlib.import_module(
            'src.provider.feature.LIFTFeature.lift_utils.networks.detector.' + sDetector)
    ...
    def buildLayersOri(self, idxSiam, verbose=True):
        ...
        orientation_module = importlib.import_module(
            'src.provider.feature.LIFTFeature.lift_utils.networks.orientation.' + sOrientation)

        # Run build
        orientation_module.build(self, idxSiam)
    ...
    def buildLayersDesc(self, idxSiam, verbose=True):
        ...
        descriptor_module = importlib.import_module(
            'src.provider.feature.LIFTFeature.lift_utils.networks.descriptor.' + sDescriptor)
